...
from file_management.file_management import do_in, do_out, do_create, do_delete, do_clean, do_list
    ...
    def __init__(self):
        ...
        if os.name == 'nt':
            try:
                ...
                print("Please install pyreadline3 for tab completion: pip install pyreadline3")
        else:
            readline.parse_and_bind("tab: complete")
